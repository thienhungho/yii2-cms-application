...
{ ?>
    <li class="dropdown dropdown-language">
        <a href="/vi-VN" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
            <img alt="" src="https://cdn2.thecatdev.com/mtn/global/img/flags/<?= get_country_code_from_language_code(get_current_client_language()) ?>.png">
        ...
        <ul class="dropdown-menu">
            ...
            <li>
                <a href="<?= \yii\helpers\Url::base(true) . '/en-US' ?>">
                    <img alt="" src="https://cdn2.thecatdev.com/mtn/global/img/flags/us.png"> United States of America </a>
            </li>
            <li>
