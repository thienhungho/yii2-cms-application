...
if (!empty($model->child)) {
    foreach ($model->child as $child) { ?>
        <div class="review" style="padding-bottom: 4px; width: 90%; float: right;">
            <div class="user-img" style="/<?= empty($child->author0->avatar) ? \thienhungho\UserManagement\models\User::DEFAULT_AVATAR : \common\modules\media\Media::getOtherSizePath('thumbnail', $child->author0->avatar) ?>"></div>
            <div class="desc">
                <h4>
