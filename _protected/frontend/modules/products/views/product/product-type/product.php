            ...
            <div class="col-lg-8">
                <div class="item-preview">
                    <div class="item__preview-slider slick-initialized slick-slider">
                        <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 7300px;"><div class="prev-slide slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0" style="width: 730px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -730px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -1460px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -2190px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -2920px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -3650px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="6" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -4380px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="7" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -5110px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="8" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -5840px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div><div class="prev-slide slick-slide" data-slick-index="9" aria-hidden="true" tabindex="-1" style="width: 730px; position: relative; left: -6570px; top: 0px; z-index: 998; opacity: 0;">
                                    <img src="images/itprv.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                                </div></div></div>
                    ...
                    <div class="item__preview-thumb">
                        <div class="prev-thumb">
                            <div class="thumb-slider slick-initialized slick-slider">
                                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 2550px; transform: translate3d(-510px, 0px, 0px);"><div class="item-thumb slick-slide slick-cloned" data-slick-index="-5" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb1.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb2.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb3.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb4.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb5.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0" style="width: 99px;">
                                            <img src="images/thumb1.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-active" data-slick-index="1" aria-hidden="false" tabindex="0" style="width: 99px;">
                                            <img src="images/thumb2.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-active" data-slick-index="2" aria-hidden="false" tabindex="0" style="width: 99px;">
                                            <img src="images/thumb3.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-active" data-slick-index="3" aria-hidden="false" tabindex="0" style="width: 99px;">
                                            <img src="images/thumb4.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-active" data-slick-index="4" aria-hidden="false" tabindex="0" style="width: 99px;">
                                            <img src="images/thumb5.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb1.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide" data-slick-index="6" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb2.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide" data-slick-index="7" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb3.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide" data-slick-index="8" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb4.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide" data-slick-index="9" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb5.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="10" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb1.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="11" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb2.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="12" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb3.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="13" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb4.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="14" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb5.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="15" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb1.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="16" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb2.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="17" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb3.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="18" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb4.jpg" alt="This is the thumbnail of the item">
                                        </div><div class="item-thumb slick-slide slick-cloned" data-slick-index="19" aria-hidden="true" tabindex="-1" style="width: 99px;">
                                            <img src="images/thumb5.jpg" alt="This is the thumbnail of the item">
                                        </div></div></div>
                        ...
                        <div class="item-action">
                            <div class="action-btns">
                                <a href="single-product.html#" class="btn btn--round btn--lg">Live Preview</a>
                ...
                <div class="item-info">
                    <div class="item-navigation">
                        <ul class="nav nav-tabs">
                            <li>
                                <a href="single-product.html#product-details" class="active" aria-controls="product-details" role="tab" data-toggle="tab">Item Details</a>
                            </li>
                            <li>
                                <a href="single-product.html#product-comment" aria-controls="product-comment" role="tab" data-toggle="tab">Comments </a>
                            </li>
                            <li>
                                <a href="single-product.html#product-review" aria-controls="product-review" role="tab" data-toggle="tab">Reviews
                                    <span>(35)</span>
                                </a>
                            </li>
                            <li>
                                <a href="single-product.html#product-support" aria-controls="product-support" role="tab" data-toggle="tab">Support</a>
                            </li>
                            <li>
                                <a href="single-product.html#product-faq" aria-controls="product-faq" role="tab" data-toggle="tab">item FAQ</a>
                            </li>
                        </ul>
                    </div>
                    <!-- end /.item-navigation -->
                    ...
                    <div class="tab-content">
                        <div class="fade show tab-pane product-tab active" id="product-details">
                            <div class="tab-content-wrapper">
                                ...
                                <h2>Features With HTML List Ordered:</h2>
                                <iframe width="100" height="400" src="https://www.youtube.com/embed/w2zIUJrglR4" allowfullscreen="" style="margin-bottom: 0px; padding-bottom: 0px;"></iframe>
                            </div>
                        </div>
                        <!-- end /.tab-content -->
                                ...
                                <ul class="media-list thread-list">
                                    <li class="single-thread">
                                        ...
                                        <div class="media depth-2 reply-comment" style="display: none;">
                                            ...
                                            <div class="media-body">
                                                <form action="single-product.html#" class="comment-reply-form">
                            ...
                            <div class="support">
                                ...
                                <div class="support__form">
                                    <div class="usr-msg">
                                        ...
                                        <form action="single-product.html#" class="support_form">
                ...
                <aside class="sidebar sidebar--single-product">
                    <div class="sidebar-card card-pricing">
                        ...
                        <div class="purchase-button">
                            <a href="single-product.html#" class="btn btn--lg btn--round">Purchase Now</a>
